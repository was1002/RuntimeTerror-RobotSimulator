...
Munkafolyamat dokumentáció esettanulmányként MI használat esetén
- [] 5-15p: Amennyiben a munka során jelentős mértékben használtatok generatív MI-t (pl. GitHub Copilot), akkor ebből lehet készíteni MI használati esettanulmányt a tanszéki gyűjteménybe. Mivel a terjedelem és a minőség itt elég tág határok között mozoghat, a kapható pontszám egy intervallum. Érdemes előre egyeztetni, hogy "mi erre-és-erre gondoltunk, ez hány pontot érne?". Részletek itt: https://bmeaut.github.io/snippets/snippets/1000_MIEsettanulmanySablon/
